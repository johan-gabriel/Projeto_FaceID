...
void loop(void)
{
    ...
    if (((auxTemp >= 1170) && (SSL[1] == 'f') && (SFC == 's')) || ((auxTemp >= 1170) && (SSL[1] == 'n') && (SFC == 's')) || ((auxTemp >= 1280) && (SFC == 'n')))
    {
    ...
    if ((inTemp >= Trpa * 117 && !trava_RPAn && (SSL[1] == 'f') && (SFC == 's')) || (inTemp >= Trpa * 117 && !trava_RPAn && (SSL[1] == 'n') && (SFC == 's')) || (inTemp >= Trpa * 128 && !trava_RPAn && (SFC == 'n')))
    {
        auxTemp = inTemp;
        inTemp = 0;
        abre = false;
