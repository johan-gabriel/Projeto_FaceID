    ...
    while (stateConfig)
    {
        ...
        while (uart_is_readable(UART_ID0))
        {
            ...
            if (i == 0)
            {
                ...
                if (resultado == 0xE1) //   Comando: #GNL Status: Em Implementação :)
                {
                    if ((comando[0] == '#') && (comando[1] == 'G') && (comando[2] == 'N') && (comando[3] == 'L'))
                    {
                ...
                {
                    if ((comando[0] == '#') && (comando[1] == 'A') && (comando[2] == 'S') && (comando[3] == 'N') && ((comando[4] == '1') || (comando[4] == '2')))
                    {
                        if (SFC == 'n')
                        {
                            if ((comando[5] != '\0') && (comando[6] != '\0'))
                            {
                                comando[5] = (comando[5] - 48) * 10;
                            }

                            Trpa = comando[5] + (comando[6] - 48);
                            abre = true;
                            if ((Trpa > 0) && (Trpa <= 99))
                            {
                ...
                if (resultado == 0xED) //   Comando: #SNL Status: Em Implementação :)
                {
                    if ((comando[0] == '#') && (comando[1] == 'S') && (comando[2] == 'N') && (comando[3] == 'L') && ((comando[4] == '1') || (comando[4] == '2')))
                    {
                ...
                {
                    if ((comando[0] == '#') && (comando[1] == 'B') && (comando[2] == 'U') && (comando[3] == 'Z') && (comando[4] == '0') && (comando[5] == '0') && ((comando[6] == '0') || (comando[6] == '3')) && ((comando[7] == '5') || (comando[7] == '0')))
                    {
...
void loop(void)
{
    ...
    if (SSL[1] == 'f')
    {
        if ((autoriza == 1) || ((autoriza == 0) && (sinalMisto = true)))
        {
            if (SPG == 'p')
            {
    ...
    if (((auxTemp >= 1110) && (SSL[1] == 'f')) || ((auxTemp >= 1220) && (SSL[1] == 'n')))
    {
        if (tempo >= (auxTemp * 0.75))
        {
            sinaliza_fim_de_giro_proximo++;
            if (sinaliza_fim_de_giro_proximo == 22)
            {
    ...
    if ((inTemp >= Trpa * 111 && !trava_RPAn && (SSL[1] == 'f')) || (inTemp >= Trpa * 122 && !trava_RPAn && (SSL[1] == 'n')) || (inTemp >= Trpa * 127 && !trava_RPAn && (SSL[1] == '\0')))
    {
        auxTemp = inTemp;
        inTemp = 0;
        abre = false;
