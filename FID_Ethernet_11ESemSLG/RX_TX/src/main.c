/*
    ...
    Versão: 1.1E (Teste de Busca e Set de IP e IS).
        comandos implementados:#ASN1/2 OK
                               #SLG
...
#define SOL1 15 // SOLENOIDE 1    
#define SOL2 27 //SOLENOIDE 2 OK (NewGPIO)
#define SENSOR2 20 //SENSOR
#define FACE_ID 26 //Sinal de liberardo externo; OK(NEWGPIO)
...
bool hora_ante = true;
bool vezin = false, azin = false;
int sentido = 0;// sentido do giro;


bool red = false, blue = false;
int y = 0; // função tempo dos comandos
int during  = 0, tag_sol = 0, gate = 0; // tempo delay para os comandos de solenoide e acionamentos em geral
