...
void RX_TX()
{
    ...
    while (stateConfig)
    {
        ...
        // novo
        if (SSL[1] != antSSL || SSH != antSSH || SPG != antSPG || dezena_SNE != antSNE || unidade_SNE != antSNEu || SFC != antSFC)
        {
...
void loop(void)
{
    ...
    if (((auxTemp >= 2850) && (SSL[1] == 'f') && (SFC == 's')) || ((auxTemp >= 2850) && (SSL[1] == 'n') && (SFC == 's')) || ((auxTemp >= 3850) && (SFC == 'n')))
    {
    ...
    if ((inTemp >= Trpa * 285 && !trava_RPAn && (SSL[1] == 'f') && (SFC == 's')) || (inTemp >= Trpa * 285 && !trava_RPAn && (SSL[1] == 'n') && (SFC == 's')) || (inTemp >= Trpa * 385 && !trava_RPAn && (SFC == 'n')))
    {
        auxTemp = inTemp;
        inTemp = 0;
        abre = false;
